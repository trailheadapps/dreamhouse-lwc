({
    rerender: function(component) {
        ...
        if (!component.map) {
            ...
            component.map = window.L.map(mapElement, { zoomControl: true }).setView([42.356045, -71.08565], 13);
        ...
        properties.forEach(function(property) {
            ...
            var callback = $A.getCallback(function(event) {
                ...
                pubsub.fireEvent('dreamhouse__propertySelected', event.target.propertyId);
            });
